...
class SplitEngine(Protocol):
    ...
    def run_prefix(self, handle: SplitRuntimeHandle, inputs: Any, *, training: bool, input_kwargs: dict[str, Any] | None = None) -> tuple[BoundaryEnvelope, PrefixContextToken | None]: ...
    def run_suffix(self, handle: SplitRuntimeHandle, boundary: BoundaryEnvelope, targets: Any = None, optimizer: Any = None, *, loss_fn: Any = None) -> SuffixResult: ...
