...
try:
    from splitfleet.proto import server_model_pb2 as server__model__pb2
...
class ServerModelStub(object):
    ...
    python -m grpc_tools.protoc -I=proto/ --python_out=splitfleet/proto/ --pyi_out=splitfleet/proto/ --grpc_python_out=splitfleet/proto/ proto/server_model.proto
    also update `splitfleet.proto.server_model_pb2` in `server_model_pb2_grpc.py`
