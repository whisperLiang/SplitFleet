...
|---:|---|---|---|---|---|
| 1 | best_global_fixed | static_heterogeneous | resource_adaptive_splitfed | edge_local_adaptive |
| 2 | static_heterogeneous | edge_local_adaptive | best_global_fixed | resource_adaptive_splitfed |
| 3 | edge_local_adaptive | resource_adaptive_splitfed | static_heterogeneous | best_global_fixed |
| 4 | resource_adaptive_splitfed | best_global_fixed | edge_local_adaptive | static_heterogeneous |
| 5 | static_heterogeneous | resource_adaptive_splitfed | edge_local_adaptive | best_global_fixed |
