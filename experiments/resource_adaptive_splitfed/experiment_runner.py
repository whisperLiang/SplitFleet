    ...
    *,
    ...
    with ResourceEmulator(dict(controls)) as emulator:
        ...
        metric = ClientMetricRecord(
            ...
            client_forward_ms=float(averaged["client_forward_ms"]),
            client_backward_ms=float(averaged["client_backward_ms"]),
            server_forward_ms=float(averaged["server_forward_ms"]),
            server_backward_ms=float(averaged["server_backward_ms"]),
            network_upload_ms=float(averaged["network_upload_ms"]),
            network_download_ms=float(averaged["network_download_ms"]),
            server_queue_ms=float(averaged["server_queue_ms"]),
            boundary_forward_bytes=round(float(averaged["boundary_forward_bytes"])),
            boundary_gradient_bytes=round(float(averaged["boundary_gradient_bytes"])),
