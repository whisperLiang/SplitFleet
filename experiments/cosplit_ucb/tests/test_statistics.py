...
from experiments.cosplit_ucb.aggregate_results import _paired_comparisons, _protocol_hash
...
def test_paired_comparisons_keep_swept_protocols_separate_and_gate_noninferiority(tmp_path) -> None:
    rows = [
        ...
        for method in ("cosplit_ucb", "best_global_fixed")
        for seed in (1, 2)
    ]
...
def test_protocol_hash_ignores_seed_batch_but_separates_resource_sweep() -> None:
    ...
    another_batch = {**base, "methods": ["cosplit_ucb"],
